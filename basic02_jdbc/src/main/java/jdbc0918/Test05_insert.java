...
public class Test05_insert {
	...
	public static void main(String[] args) {
		...
		try {
			...
			pstmt.setString(1, name); //1-> 첫번째 물음표, uname 컬럼
			pstmt.setInt(2, kor);  	  //2-> 두번째 물음표, kor 컬럼
			pstmt.setInt(3, eng);     //3-> 세번째 물음표, eng 컬럼
			pstmt.setInt(4, mat);     //4-> 네번째 물음표, mat 컬럼
			pstmt.setString(5, addr);    //5-> 다섯번째 물음표, addr 컬럼
