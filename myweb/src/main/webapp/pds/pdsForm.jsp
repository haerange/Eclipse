...
<form method="post" action="pdsIns.jsp" enctype="multipart/form-data" onsubmit="return pdsCheck()">
	...
	<tr>
		...
		<td style="text-align: left">
			<input type="text" name="wname" id="wname" size="20" maxlength="5">
		</td>		
	</tr>
	<tr>
		<th>제목</th>
	...
	<tr>
		<th>첨부파일</th>
		<td style="text-align: left">
			<!-- <input type="file" name="filenm" id="filenm" size="20"> 오타-->	
			<input type="file" name="filename" id="filename" size="20">
		</td>		
	</tr>
	<tr>
	   <td colspan="2">
	     <input type="submit" value="사진보내기" class="btn btn-success">
