...
%>
		...
		<tr>
			<th>영어</th>
			<td><input type="number" name="eng" id="eng" value="<%=dto.getEng()%>" size="5" min="0" max="100" placeholder="영어점수"></td>
		</tr>	
		<tr>
			<th>수학</th>
			<td><input type="number" name="mat" id="mat" value="<%=dto.getMat()%>" size="5" min="0" max="100" placeholder="수학점수"></td>
	<tr>
			<th>주소</th>
			<td>
			<% String addr = dto.getAddr(); %>
				<select name="addr" id="addr" value="<%=dto.getAddr()%>">
